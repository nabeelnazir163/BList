...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    @IBInspectable open var maxValue: CGFloat = 220.0 {
        didSet {
            refresh()
        }
    }
    ...
    open override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        let insetExpansion: CGFloat = -40.0
    ...
    private func setup() {
        ...
        let labelFrame: CGRect = CGRect(x: 0.0, y:sliderLine.frame.origin.y - 28, width: 75.0, height: 14.0)

        minLabelFont = UIFont(name: "Cabin-Bold", size: 12.0)!
        ...
        minLabel.backgroundColor = UIColor.black.cgColor
        layer.addSublayer(minLabel)

        maxLabelFont = UIFont(name: "Cabin-Bold", size: 12.0)!
        ...
        maxLabel.backgroundColor = UIColor.black.cgColor
    ...
    private func updateLabelPositions() {
       minLabel.frame.size = minLabelTextSize
        ...
        if disableRange || newSpacingBetweenTextLabels > minSpacingBetweenLabels {
            ...
            minLabel.frame.origin.y = sliderLine.frame.maxY + 8
            maxLabel.frame.origin.y = sliderLine.frame.maxY + 8
        } else {
